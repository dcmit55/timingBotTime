...
// <?php
// /**
//  * Proxy endpoint untuk mengambil data projects dari Laravel API
//  * Endpoint Laravel: http://127.0.0.1:8000/api/v1/projects
//  * 
...
$apiUrl = 'https://mascotenterpriseid.com/api/v1/projects';
...
try {
    ...
    // Log error (optional)
    error_log('[projects_proxy.php] Error: ' . $e->getMessage());
