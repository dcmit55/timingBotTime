<?php
/**
 * Proxy endpoint untuk mengambil data parts dari Laravel API
 * Endpoint Laravel: http://127.0.0.1:8000/api/v1/parts?project_id={id}
 * 
...
// Ambil project_id dari query parameter
...
if ($projectId <= 0) {
    ...
    echo json_encode([
        ...
        'source' => 'parts_proxy.php'
    ]);
    exit;
}

// SymCore API Configuration
$apiUrl = "https://mascotenterpriseid.com/api/v1/parts?project_id={$projectId}";
...
try {
    ...
    // Log error (optional)
    error_log("[parts_proxy.php] Error for project_id={$projectId}: " . $e->getMessage());
